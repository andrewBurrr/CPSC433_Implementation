...
public class SetBased{
    ...
    public Fact run()  {
        ...
        //Uses an or-tree based search to generate initial solutions for the set based genetic search
        ...
        //Primary control loop. Implements the set based search control.
        getVariance();
        Random rand = new Random();
        while(variance>threshold || facts.size()<(maxPopulation*(0.9-killPercent))){
            ...
            //If the current state is too large, reduce the population with Tod()
            Fact newFacts[] = new Fact[2];
